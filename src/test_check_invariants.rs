pub mod tests {
    ...
    impl GlobalState {
        ...
        fn change_variables(
            ...
            raft_state: Option<RaftRole>,
            term_voted_for: Option<(u64, Option<NID>)>,
            snapshot_log: Option<(SnapshotRange<String>, Vec<LogEntry<String>>)>,
    ...
    impl InvariantChecker {
        ...
        pub fn set_and_check_invariants<T: MsgTrait + 'static>(
            ...
            raft_state: Option<RaftRole>,
            term_voted_for: Option<(u64, Option<NID>)>,
            snapshot_log: Option<(SnapshotRange<T>, Vec<LogEntry<T>>)>,
            ...
            for (_id, state) in node_states.iter() {
                ...
                for i in 0..state.log.len() {
                    ...
                    if i > 0 {
                        ...
                        assert_eq!(i, 0);
                        assert_eq!(state.snapshot.end_index, index,
                ...
                for e in state.snapshot.entries.to_set() {
